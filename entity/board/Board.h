...
namespace Chess
{
    ...
    public:
        ...
        std::map<ChessPieceType, std::unordered_set<std::shared_ptr<Piece>>>& GetWhitePieces() { return m_whitePieces; };
        std::map<ChessPieceType, std::unordered_set<std::shared_ptr<Piece>>>& GetBlackPieces() { return m_blackPieces; };
